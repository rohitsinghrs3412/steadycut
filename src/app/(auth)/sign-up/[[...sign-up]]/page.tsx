...
export default function SignUpPage() {
  ...
  return (
    <AuthShell eyebrow="Start steady" title="Create your SteadyCut account">
      <SignUp
      ...
      <section className="hidden flex-col justify-between border-r bg-sidebar p-10 lg:flex">
        ...
        <div className="max-w-md">
          ...
          <p className="mt-4 text-base leading-7 text-muted-foreground">
            Keep the weight-loss loop simple: log food, weigh in, finish habits,
            repeat.
          </p>
        </div>
        <div className="text-sm text-muted-foreground">
          Private by default. Yours every day.
        </div>
      </section>
      <section
        className={cn(
